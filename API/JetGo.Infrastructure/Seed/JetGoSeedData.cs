...
internal static class JetGoSeedData
{
    ...
    [
        new Flight
        {
            ...
            DestinationId = 1,
            FlightNumber = "JG100",
            DepartureAtUtc = Utc(2026, 12, 10, 8, 0),
            ArrivalAtUtc = Utc(2026, 12, 10, 9, 10),
            BasePrice = 129.00m,
            TotalSeats = 6,
            AvailableSeats = 6,
        ...
        new Flight
        {
            ...
            DestinationId = 2,
            FlightNumber = "JG101",
            DepartureAtUtc = Utc(2026, 12, 10, 12, 30),
            ArrivalAtUtc = Utc(2026, 12, 10, 13, 55),
            BasePrice = 149.00m,
            TotalSeats = 6,
            AvailableSeats = 6,
            Status = FlightStatus.Scheduled,
        ...
        new Flight
        {
            ...
            DestinationId = 3,
            FlightNumber = "JG102",
            DepartureAtUtc = Utc(2026, 12, 11, 7, 45),
            ArrivalAtUtc = Utc(2026, 12, 11, 8, 50),
            BasePrice = 99.00m,
            TotalSeats = 6,
            AvailableSeats = 6,
            Status = FlightStatus.Scheduled,
        ...
        new Flight
        {
            ...
            DestinationId = 4,
            FlightNumber = "JG103",
            DepartureAtUtc = Utc(2026, 12, 11, 15, 20),
            ArrivalAtUtc = Utc(2026, 12, 11, 17, 50),
            BasePrice = 179.00m,
            TotalSeats = 6,
            AvailableSeats = 6,
            Status = FlightStatus.Scheduled,
        ...
        new Flight
        {
            ...
            DestinationId = 5,
            FlightNumber = "JG104",
            DepartureAtUtc = Utc(2026, 12, 12, 6, 10),
            ArrivalAtUtc = Utc(2026, 12, 12, 8, 30),
            BasePrice = 199.00m,
            TotalSeats = 6,
            AvailableSeats = 6,
            Status = FlightStatus.Scheduled,
        ...
        new Flight
        {
            ...
            DestinationId = 6,
            FlightNumber = "JG105",
            DepartureAtUtc = Utc(2026, 12, 12, 18, 0),
            ArrivalAtUtc = Utc(2026, 12, 12, 19, 20),
            BasePrice = 139.00m,
            TotalSeats = 6,
            AvailableSeats = 6,
            Status = FlightStatus.Scheduled,

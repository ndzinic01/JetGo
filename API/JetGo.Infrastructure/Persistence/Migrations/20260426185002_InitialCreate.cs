        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Destinations_DifferentAirports", "[DepartureAirportId] <> [ArrivalAirportId]");
                    table.ForeignKey(
                        name: "FK_Destinations_Airports_ArrivalAirportId",
                        column: x => x.ArrivalAirportId,
                        principalTable: "Airports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Destinations_Airports_DepartureAirportId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Flights_ArrivalAfterDeparture", "[ArrivalAtUtc] > [DepartureAtUtc]");
                    table.CheckConstraint("CK_Flights_SeatsPositive", "[TotalSeats] >= 0 AND [AvailableSeats] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SearchHistories_Destinations_DestinationId",
                        column: x => x.DestinationId,
                        principalTable: "Destinations",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservationItems_FlightSeats_FlightSeatId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Destinations_ArrivalAirportId",
                table: "Destinations",
                column: "ArrivalAirportId");

            migrationBuilder.CreateIndex(
                name: "IX_Destinations_DepartureAirportId",
                table: "Destinations",
                column: "DepartureAirportId");

            migrationBuilder.CreateIndex(
                name: "IX_Destinations_RouteCode",
                table: "Destinations",
                column: "RouteCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightSeats_FlightId_SeatNumber",
                table: "FlightSeats",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationItems_FlightSeatId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SearchHistories_DestinationId",
